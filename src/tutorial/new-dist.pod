...
You may also consider using the "L<@Starter|Dist::Zilla::PluginBundle::Starter>"
bundle, which is similar to "@Basic" but with a more updated plugin selection.
As with "@Basic", be sure to read the documentation so you know what plugins you
will be using.
